...
public interface BookDao extends AbstractDao<Book>{
	 ...
	 */
    public abstract List<Book> findBookByCatalogId(long id);
	 ...
	 * otherwise return null 
	 */
    public abstract List<Book> findBookByAuthor(String surname);
	 ...
	 * otherwise return null 
	 */
    public abstract Book findBookByCopy(long id);
}