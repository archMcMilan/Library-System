 ...
 * Command that provides operation searching Book objects by Author 
 */
public class FindBookByAuthorCommand implements Command{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		String surname = request.getParameter(CommandConstant.PARAMETER_AUTHOR);
		List<Book> result = bookService.findBookByAuthor(surname);
